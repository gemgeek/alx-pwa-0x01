...
const Movies: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#110F17] text-white px-4 md:px-10 lg:px-44">
      <div className="py-16">
        <div className="flex flex-col md:flex-row justify-between mb-4 items-center space-y-4 md:space-y-0 md:space-x-4">
          <input
            type="text"
          ...
          <select
            ...
            className="border-2 border-[#E2D609] outline-none bg-transparent px-4 md:px-8 py-2 rounded-full w-full md:w-auto text-white [&>option]:bg-[#110F17]"
          >
        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          <h1 className="text-lg md:text-6xl font-bold">{year || 'Latest'} {genre !== 'All' ? genre : ''} Movie List</h1>
          <div className="flex flex-wrap space-x-2 md:space-x-4 mt-4 md:mt-0">
            {
